...
## SSO 更新機制
![](http://latex.codecogs.com/gif.latex?\\\begin{equation}\LARGE X_{t+1,i,j}=\left\{\begin{array}{lr}p\small_{gBest,j} \LARGE\  \ \  if\ \rho_{[0,1]}\epsilon [0,C_g)\\\end{array}\right.\end{equation})
